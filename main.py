...
from kivy.uix.image import Image as Maddy
import time
from kivy.app import App
...
class CameraScreen(Screen):
    ...
    def changeScreen(self):
        ...
        if len(boxes)>0:
            prompt = "Successful scan!"
            tts = gTTS(text=prompt, lang='en', slow=False)
            tts.save("scan_success.mp3")
            ...
            prompt = "We could not find any text. Please provide a clearer photo."
            tts = gTTS(text=prompt, lang='en', slow=False)
            tts.save("scan_fail.mp3")
            playsound("scan_fail.mp3")
...
class ControlScreen(Screen):
    ...
    def init_things(self):
        ...
        prompt = "Ready to go!"
        tts = gTTS(text=prompt, lang='en', slow=False)
        tts.save("ready_to_go.mp3")
        playsound("ready_to_go.mp3")
